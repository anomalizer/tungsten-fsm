 ...
 * @version 1.0
 */
public class EventPayloadTypeGuard implements Guard
{
    private final Class<?> type;

    public EventPayloadTypeGuard(Class<?> type)
    {
        this.type = type;
    }
     ...
     *
     * {@inheritDoc}
     * @see Guard#accept(Event, Entity, State)
     */
    public boolean accept(Event message, Entity entity, State state)
    {
        return (type.isInstance(message.getData()));
    }
}
